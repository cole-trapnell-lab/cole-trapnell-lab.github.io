...
Each paper lives in [`papers/_posts/`](https://github.com/blab/blotter/tree/master/papers/_posts).  File names, used to construct permalinks, are first author plus short (1-2 word) title, for example [`2012-04-30-trapnell-canalization.md`](https://github.com/blab/blotter/blob/master/papers/_posts/2012-04-30-trapnell-canalization.md).   Papers have the following YAML metadata:

```
---
layout: paper
title: Canalization of the evolutionary trajectory of the human influenza virus
image: /images/papers/trapnell-canalization.png
authors: Bedford T, Rambaut A, Pascual M.
year: 2012
ref: Bedford et al. 2012.
journal: "BMC Biol 10: 38."
pdf: /pdfs/papers/trapnell-canalization.pdf
supplement: /pdfs/papers/trapnell-canalization-supp.pdf
...
Each team member has a Markdown file in [`team/_posts/`](https://github.com/blab/blotter/tree/master/team/_posts).  File names are join date followed by first and last name, like [`2013-09-30-trevor-trapnell.md`](https://github.com/blab/blotter/blob/master/team/_posts/2013-09-30-trevor-trapnell.md).  YAML follows:
...
handle: trvrb
email: trvrb@trevortrapnell.com
twitter: trvrb
github: trvrb
image: /images/team/trevor-trapnell.jpg
cv: /pdfs/team/trapnell-cv.pdf
---
```
